...
const tipo_examen_entity_1 = require("./tipo-examen.entity");
...
__decorate([
    (0, typeorm_1.ManyToOne)(() => tipo_examen_entity_1.TipoExamen, tipoExamen => tipoExamen.resultados),
    __metadata("design:type", tipo_examen_entity_1.TipoExamen)
